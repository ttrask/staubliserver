...
***********************************************/
public void P5Motion_Init (CP5DLL *device, int id){
	myP5Device = device;
	bP5Id = id;
}
...
public void P5Motion_SetClipRegion(int xstart, int xend, int ystart, int yend, int zstart, int zend)
{
	nxclipstart = xstart;
	nxclipend = xend;
	nyclipstart = ystart;
...
public void P5Motion_InvertMouse(int xaxis, int yaxis, int zaxis)
{
	nxinvert = xaxis;
	nyinvert = yaxis;
	nzinvert = zaxis;
...
public void P5Motion_FilterXYZ()
{
	static int firsttime = 1;
	if (myP5Device != nullptr)
	{
		if (firsttime==1)
		{
...
public void P5Motion_FilterYPR()
{
	static int firsttime = 1;
	if (myP5Device != nullptr)
	{
