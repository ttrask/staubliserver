...
//-----------------------------------------------------------------------------
C3DFont::C3DFont( TCHAR* strFontName, DWORD dwHeight, DWORD dwFlags )
{
...
//-----------------------------------------------------------------------------
HRESULT C3DFont::InitDeviceObjects( LPDIRECT3DDEVICE8 pd3dDevice )
{
    HRESULT hr;
    ...
    DWORD dwBold   = (m_dwFontFlags&C3DFONT_BOLD)   ? FW_BOLD : FW_NORMAL;
    DWORD dwItalic = (m_dwFontFlags&C3DFONT_ITALIC) ? TRUE    : FALSE;
...
// Desc:
//-----------------------------------------------------------------------------
HRESULT C3DFont::RestoreDeviceObjects()
{
    HRESULT hr;
...
//-----------------------------------------------------------------------------
HRESULT C3DFont::InvalidateDeviceObjects()
{
    SAFE_RELEASE( m_pVB );
...
// Desc: Destroys all device-dependent objects
//-----------------------------------------------------------------------------
HRESULT C3DFont::DeleteDeviceObjects()
{
...
//-----------------------------------------------------------------------------
HRESULT C3DFont::GetTextExtent( TCHAR* strText, SIZE* pSize )
{
...
//-----------------------------------------------------------------------------
HRESULT C3DFont::DrawTextScaled( FLOAT x, FLOAT y, FLOAT z,
...
// Desc: Draws 2D text
//-----------------------------------------------------------------------------
HRESULT C3DFont::DrawText( FLOAT sx, FLOAT sy, DWORD dwColor,
                            TCHAR* strText, DWORD dwFlags )
{
    if( m_pd3dDevice == NULL )
        return E_FAIL;

	//IGOR - make stats toggable
	if(!g_bShowStats)
		return S_OK;
...
//-----------------------------------------------------------------------------
HRESULT C3DFont::Render3DText( TCHAR* strText, DWORD dwFlags )
{
    if( m_pd3dDevice == NULL )
        return E_FAIL;
